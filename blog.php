...
<body>
  ...
  <section id="header-title">
    <div class="container">
      ...
      <div class="d-flex w-100 justify-content-center py-3">
        ...
        <h1>Blog<?= ($_GET['ref']) ? ' - ' . $infoTema['nome_assunto'] : '' ?></h1>
      </div>
  ...
  <section id="blog-div" style="background-color: white !important;">
    <div class="container">
      <div class="row col-12 pr-0">
        <div class="col-md-4 pt-3 offset-md-8">
          <select class="form-control my-5" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
            ...
            <? while ($rowAssunto = mysql_fetch_array($resAssunto)) { ?>
              <option <?= ($_GET['ref'] == $rowAssunto['id_assunto']) ? 'selected' : '' ?> value="blog/assunto<?= $rowAssunto['id_assunto'] ?>/<?= cleanString($rowAssunto['nome_assunto']) ?>"><?= $rowAssunto['nome_assunto'] ?></option>
            <? } ?>
          </select>
        </div>
        <? while ($rowResult = mysql_fetch_array($resResult)) { ?>
          <div class="col-md-4">
            ...
            <a href="blog/<?= cleanString($rowResult['titulo_post']); ?>-<?= $rowResult['id_post'] ?>"><h3><?= $rowResult['titulo_post'] ?></h3></a>
